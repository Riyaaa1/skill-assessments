...
# Filtering the data to include only rows where Year is 1962
...
# Year with strongest correlation between 'CO2 emissions (metric tons per capita)'and gdpPercap
...
## Scatter plot comparing 'CO2 emissions (metric tons per capita)'and gdpPercap
...
# Statistical tests to determine relationship between continent and 'Energy use (kg of oil equivalent per capita)'
